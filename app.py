...
def webhook():
    ...
    if state == "craving_trigger" and text in [
        ...
        actions = {
            "😰 Стресс":
                "Сделай 5 медленных вдохов и выдохов. Затем выпей стакан воды и на 5 минут смени обстановку.",

            "😴 Скука":
                "Встань и займи себя на 5 минут: пройдись, умойся, включи музыку или сделай небольшое дело.",

            "🍺 Компания / алкоголь":
                "Отойди от ситуации хотя бы на 5 минут. Возьми воду или другой напиток и не принимай решение прямо сейчас.",

            "☕ Привычная ситуация":
                "Сломай привычную связку: поменяй место, напиток или действие. Дай мозгу другой сценарий хотя бы на 5 минут.",
        ...
        send_message(
            chat_id,
            "<b>Сейчас не нужно побеждать навсегда.</b>\n\n"
            f"{actions[text]}\n\n"
            "Твоя задача — только не действовать на автомате ближайшие несколько минут.\n\n"
            "После этого выбери:",
            keyboard
        )
